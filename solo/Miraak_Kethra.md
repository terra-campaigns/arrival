...
Reading: A sole survivor angel golem (an experiment to fight the Turnskull constructs), from a fallen Supraxis, after a Turnskull attack (level 1 left). The angel golem is very aggressive. The golem is beautifully depraved and mis-constructed.

![](https://i.imgur.com/FQwvKEf.png)
...
On the following day they turn south towards Mystra's temple. It is a know desert route (rank dangerous, progress 4 hexes) `Kethra rolls +Wit: 12 for S+`. The group find a hidden stash of desert wine buried close to one of the ruins. After a quick forage for herbs and small animals, the group have a relaxing evening drinking around the fire and telling stories. They are ready to arrive in Mystra's temple.
...
Kethra introduces her travelling party `Kethra rolls +Will: 14 for S+`. The group is well received in the temple. One of the priests remembers Miraak and Kethra's friendship with Amyria and offers them hospitality. While eating, Miraak ends up meeting an adventurer that just travelled to the mountains, and he shares that Kathadzig is well populated by the dwarves again - but they something meaner in their temper.

On the next day, the group departs early to find the shaft towards the Ardismouth temple `Kethra rolls +Will: 12 for S+` and finds it in a couple of hours of search. The three broken heroes go into the temple tower and climb it down to progress the rest of their journey in the tunnels of the Ammuinoth `Kethra rolls +Will: 12 for S+`. They remember exactly how to stay safe in the tunnels and travel very silently (_Formidable_ journey, *known* path: 3 hexes/progress). The group is also lucky to find wild mushrooms and have enough light through a broken wall to plan the next day.

After waking up, the group is quickly travelling through the tunnels again `Kethra rolls +Will +1: 16 for S+`. Their lucky continues strong, and they find again good forage and spend time planning for the next day. For the third day, the group is going to try their luck, but travelling very fast to arrive in one single day to the Castle of Bells, hoping to find Weldon soon `Kethra rolls +Will +1 -4: 10 for S+`.

Upon arrival in the Castle of Bells, they are lucky to find Weldon in a good mood. The heroes explain their goal to take down Ghuse, and Kethra discusses with Weldon the possibility of him joining the fray `Kethra rolls +Will: 11 for S+`. Weldon is aware of all the bad that Ghuse has been doing in the mountain - effectively turning it into an industrial site to exploit the war that is about to start between the Acrisae and Turnskull.
...
| Gulthas   | Dmg-SS            | 0-0   |
| Party     | Encounter         | 4/6   |
| Party     | Weakness Glasrath | 3/6   |

# Securing the upper hand

**Current force in Glasrath**

- **Ghuse's** 2000 undead - all working in the mines
	- 2 Vast Mobs of 30 HD (500 each)
	- 6 Large Mobs of 20 HD (100 each)
	- 20 Small Mobs of 10 HD (20 each)
- **Ghuse's** 120 loyal soldiers (humans and drows)
	- 4 Small Mobs of 12 HD (20 each) stationary in Khathadzig
	- 2 Small Mobs of 12 HD (20 each) working in the mines
- **Resistance's** 80 dwarves
	- 2 Small Mobs of 12 HD (20 each) working in Khathadzig
	- 2 Small Mobs of 12 HD (20 each) doing slave labour in the mines

What is happening is Glasrath (tarot):

- **1 Main**: Discord
- **2 Past**: 4/Roses Growth - Gain power and expand. An idea grows into an obsession, desire. Cancer.
- **3 Next**: 5/Eyes Division - Rally, Arson, Heated debates.
- **4 Weakness**: 5/Roses Predator - Stalking, ambush and hidden motifs.
- **5 Strength**: 1/Roses Gaia - Stronger kills the weaker, loosing control, a body that changes.

**Reading**: While Ghuse transforms Glasrath in an industrial scale production site, the resistance grows stronger. The dwarves were made aware of the presence of Weldon, the Werebear, in the Castle of Bells. They have been rallying Weldon to join forces with them, and have been causing troubles to Ghuse's interests. Ghuse becomes afraid of the situation and start dealing with the population in his dread dragon form. All is set for the resistance's execution to take down Ghuse and the undead.

When the group arrives and meet Weldon, they are made aware of the current situation. Their approach is to make contact with the Dwarves in Khatadzig and, from there, launch small forces to free the enslaved Dwarves in the mine.

![](https://i.imgur.com/1Tqjf5x.png)
